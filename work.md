...
Here is an exhaustive list of my projects during various parts of my journey.

## At NeenOpal

I work at the intersection of analytics, business intelligence & machine learning.
At work, I spend (and have spent) most of my time on:

<ul>
      <li><b>Analytics:</b> Generating insights from client's data and building data-driven solutions to improve their operational efficiency and quality of decision making.</li>
      <li><b>Dashboarding:</b> Making dashboards to help the clients to quickly gain insights into the most important aspects of their data.</li>
</ul>

### Projects I worked at NeenOpal 

- **Employee Scoring:** 

  Analyzed monthly performance of Marketing and Recovery officers of a leading NBFI in Sri Lanka and scored them based on their performance. Collected and made various features that impacts the performance of the employee. Built tableau dashboards and presented scores of the employees and other important KPIs to the stakeholders. The dashboard gets updated every month, helping the client to gain insights into the most important aspects of the employee performance.

- **Demand forecasting and Inventory management:** 

  Leveraged machine learning to build hybrid models in order to predict the sales at store and SKU level(500+ stores and 1000+ SKUs) for one of the largest Tiles producers in Sri Lanka. Managed monthly forecasting process and reported observations to the stakeholders using Tableau. Built ensemble model for forecasting and achieved 85% accuracy. Deployed the forecasts and other important details on Qlikview dashboards.
